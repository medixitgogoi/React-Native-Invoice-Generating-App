  ...
  {products?.map(item => (
    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#fff', padding: 10, elevation: 1, borderRadius: 8 }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5, }}>
        ...
        <Text style={{ color: '#fff', fontSize: responsiveFontSize(2), fontWeight: '500', backgroundColor: zomatoRed, paddingVertical: 3, paddingHorizontal: 7, borderRadius: 8 }}>{item?.length} {unit}</Text>
      </View>
